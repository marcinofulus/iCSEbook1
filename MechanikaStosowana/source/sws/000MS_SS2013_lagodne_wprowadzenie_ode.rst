...
.. code-block:: python
    ...
    desolve_odeint([f, g],                          [x0, y0],             srange(0, t_end, dt),      [x, y])
...
Przykład1: oscylator harmoniczny
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
Rozwiązanie jest tablicą numpy (zob.  `https://sage2.icse.us.edu.pl/home/pub/114/ `_ ), która może być wygodnie i wydajnie przeszukiwana przez technikę "slicing", np:
