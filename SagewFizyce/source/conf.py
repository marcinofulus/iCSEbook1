...
latex_documents = [
  ('index', 'sage_w_fizyce.tex', u'Sage w fizyce - Skrypt',
   u'iCSE', 'manual'),
]
...
man_pages = [
    ('index', 'sage_w_fizyce', u'Sage w fizyce - Skrypt',
     [u'iCSE'], 1)
]
...
texinfo_documents = [
  ('index', 'sage_w_fizyce', u'Sage w fizyce - Skrypt',
   u'iCSE', 'sage_w_fizyce', 'One line description of project.',
   'Miscellaneous'),
]
