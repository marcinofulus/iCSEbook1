...
$(document).ready(function (){
  var holder = $('<div class="sidebartoggle"><button id="sidebar-hide" title="Ukryj menu">Menu</button><button id="sidebar-show" style="display: none" title="Pokaż menu">Menu</button></div>');
  var doc = $('body');
  ...
  hide_btn.click(function (){
    doc.removeClass("expanded-sidebar");
    show_btn.show();
    hide_btn.hide();
  ...
  $('.relbar-top .related').prepend(holder);
  $('.relbar-top .related').append('<div class="clearer"></div>');
  ...
  $('.document').click(function() {
    if ($('body').hasClass('expanded-sidebar') && $(window).width() < 960) {
      $('body').removeClass("expanded-sidebar");
      show_btn.show();
      hide_btn.hide();
      $.cookie("sidebar", "collapsed", copts);
      $(window).trigger("cloud-sidebar-toggled", true);
