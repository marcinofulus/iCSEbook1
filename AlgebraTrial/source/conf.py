# -*- coding: utf-8 -*-
#
# Algebra Liniowa documentation build configuration file, created by
...
htmlhelp_basename = 'AlgebraLiniowa'
...
latex_documents = [
  ('index', 'AlgebraLiniowa.tex', u'Algebra Liniowa',
...
man_pages = [
    ('index', 'AlgebraLiniowa', u'Algebra Liniowa',
     [u'Marcin Kostur'], 1)
]
...
texinfo_documents = [
  ('index', 'AlgebraLiniowa', u'Algebra Liniowa',
   u'Marcin Kostur', 'AlgebraLiniowa', 'One line description of project.',
   'Miscellaneous'),
]
