...
latex_documents = [
  ('index', 'AlgebraLiniowa.tex', u'Linear Algebra',
   u'Marcin O. Fulus \& Jaks Amit', 'manual'),
]
...
man_pages = [
    ('index', 'AlgebraLiniowa', u'Linear Algebra',
     [u'Marcin Kostur'], 1)
]
