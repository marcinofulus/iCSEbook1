...
Integrationsgrenze bei :math:`t=1`. Damit ist :math:`F(1)=0`. Schließlich
schätzt man durch Abzählen von Kästchen
:math:`F(0)=-\int\limits_0^1f(t)\mathrm{d}t` zu :math:`\frac{1}{2}` ab.
