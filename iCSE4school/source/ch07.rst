...
**At the beginning** we recall that :math:`\sqrt{2}` is an irrational number - we can only get close to it. Look
...
.. sagecellserver::
  ...
  var('R,E,rw,J,P,U')
sol = solve([R+rw == E/J,P == U*J,R==U/J],[P,J,U],solution_dict=True)
show
